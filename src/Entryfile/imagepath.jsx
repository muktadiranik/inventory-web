...
export { default as Banner } from "Assets/img/banner.jpg";
export { default as Logo } from "Assets/img/logo-copy.png";

// Landing Page Images And Icons
export { default as LandingLogo } from "Assets/img/landing/languagemodal.png";
export { default as CardIcon_1 } from "Assets/img/landing/organized.png";
export { default as CardIcon_2 } from "Assets/img/landing/refund.png";
export { default as CardIcon_3 } from "Assets/img/landing/technical-support.png";
export { default as CardIcon_4 } from "Assets/img/landing/time.png";

export { default as CardImage_1 } from "Assets/img/landing/Mobile.png";
export { default as CustomerImage } from "Assets/img/landing/customerimg1.png";
export { default as InvoiceImage } from "Assets/img/landing/invoiceimage.png";
export { default as HomeMainImage } from "Assets/img/landing/homeimage.png";

export { default as CardIcon_5 } from "Assets/img/landing/invoiceicon1.png";
export { default as CardIcon_6 } from "Assets/img/landing/invoiceincon2.png";
export { default as CardIcon_7 } from "Assets/img/landing/invoiceicon3.png";
export { default as seal } from "Assets/img/landing/seal.svg";
