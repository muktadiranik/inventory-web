...
const Investors = () => {
      ...
      render: (row) => (
        <div className='btn btn-group'>
          ...
          <a
            ...
            data-bs-target='#update_investor'
            onClick={() => {
              setUserObject(row);
            }}>
  ...
  useEffect(() => {
    if (company) {
      if (company.id) {
        dispatch(getCSIBListAction(company.id, "INVESTOR"));
  ...
  }, [addedCSIB, company, updatedCSIB, deleteSuccess]);
  ...
  useEffect(() => {
    if (ref1.current) {
      ...
      if (success) {
        if (addedCSIB) {
          if (addedCSIB.customer_type) toast.success("Investor added");
        }
      }
    }
    ref1.current = true;
  ...
  useEffect(() => {
    if (ref2.current) {
      ...
      if (success) {
        if (updatedCSIB) {
          if (updatedCSIB.customer_type) toast.success("Investor updated");
        }
      }
    }
    ref2.current = true;
  ...
  return (
    <div className='page-wrapper'>
      ...
      <div className='content container-fluid'>
              ...
              <div className='col-auto float-end ml-auto'>
                <a
                  ...
                  {userPreference && userPreference.language_name === "EN" ? (
                    ...
                    <span>বিনিয়োগকারী যোগ করুন</span>
                  )}
                </a>
              </div>
            )}
        ...
        {customerType && <AddInvestor customerType={customerType} />}
        {customerType && <UpdateInvestor userObject={userObject} />}
        <div className='row '>
          <div className='card'>
