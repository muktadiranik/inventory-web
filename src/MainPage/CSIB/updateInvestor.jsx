...
import { updateCSIBAction } from "../../redux/actions/customerActions";

const UpdateInvestor = ({ userObject }) => {
  ...
  const onSubmit = (event) => {
    ...
    let promise = new Promise((resolve, reject) => {
      dispatch(updateCSIBAction(company.id, formData, userObject.id));
      resolve();
    });
    promise.then(() => {
  ...
  useEffect(() => {
    ...
    setCustomerType(userObject.customer_type);
  }, [userObject]);
